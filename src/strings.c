...
const u8 gText_Boy[] = _("A");
const u8 gText_Girl[] = _("B");
...
ALIGNED(4) const u8 gString_PokemonFireRed_Staff[] = _("Pokémon LibraRed Version\nStaff");
ALIGNED(4) const u8 gString_PokemonLeafGreen_Staff[] = _("Pokémon LibraGreen Version\nStaff");
